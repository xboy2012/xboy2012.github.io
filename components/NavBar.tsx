...
export const NavBar = () => {
  return (
    <nav
      className={cx(
        'fixed bottom-0 left-0 z-5 w-full border border-solid border-jet bg-navbar shadow-2 backdrop-blur-2.5 xl:shadow-none',
        'xl:absolute xl:top-0 xl:right-0 xl:bottom-auto xl:left-auto xl:w-max xl:px-5',
        'rounded-t-xl',
        'md:rounded-t-2.5xl',
        'xl:rounded-tl-none xl:rounded-tr-2.5xl xl:rounded-br-none xl:rounded-bl-2.5xl',
        'print:hidden',
      )}
    >
