import type { BlogData, BlogDataLazy } from '../types';
import src from '../utils/getImageUrl';
import { defineLazyObject } from '../utils/defineLazyObject';

let _blogs: ReadonlyArray<BlogData>;

export const getBlogs = () => {
  if (!_blogs) {
    const blogsLazy: BlogDataLazy[] = [
      {
        id: 'learn-react-js',
    ...
    _blogs = blogsLazy.map((o) => defineLazyObject(o));
  }
  return _blogs;
};
